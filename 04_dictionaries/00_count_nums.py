...
def get_user_numbers():
    ...
    while True:
        ...
        # Immediately count and display the number counts after each entry
...
def main():
    ...
    """
    print("Start entering numbers. Press Enter without typing a number to stop.\n")
